...
func (c *controller) editProfile(index int) {
	...
	ike := entry(p.IKEProposal, "aes128-sha256-modp1536,aes128-sha256-modp2048", false)
	esp := entry(p.ESPProposal, "aes128-sha256-modp1536,aes256-sha256-modp1536", false)
	reauth := entry(p.ReauthTime, "86400s", false)
